...
public interface InformationmodelEnhancedRepository extends ElasticsearchRepository<InformationModelEnhanced, String> {
    ...
    List<InformationModelEnhanced> getByHarvestSourceUri(String harvestSourceUri);

    @Query("{\"bool\":{\"must\":[{\"query_string\":{\"default_field\":\"id\",\"query\":\"\\\"?0\\\"\"}}]}}")
    Optional<InformationModelEnhanced> getById(String id);
