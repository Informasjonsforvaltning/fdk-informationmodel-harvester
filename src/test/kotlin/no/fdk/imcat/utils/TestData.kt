...
const val ELASTIC_NETWORK_NAME = "elasticsearch5test"
const val ELASTIC_CLUSTERNAME = "elasticsearchtest"
...
val API_ENV_VALUES: Map<String, String> = mapOf(
        ...
        "FDK_ES_CLUSTERNAME" to ELASTIC_CLUSTERNAME,
...
val ELASTIC_ENV_VALUES: Map<String, String> = mapOf(
        "cluster.name" to ELASTIC_CLUSTERNAME,
